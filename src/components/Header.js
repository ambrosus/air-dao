        ...
        <nav className='header__nav'>
          <ul>
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'about' ? ' header__nav-link_active' : ''
                }`}
                href='#about'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'get-amb' ? ' header__nav-link_active' : ''
                }`}
                href='#get-amb'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'staking' ? ' header__nav-link_active' : ''
                }`}
                href='#staking'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'community' ? ' header__nav-link_active' : ''
                }`}
                href='#community'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'network' ? ' header__nav-link_active' : ''
                }`}
                href='#network'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'bridge' ? ' header__nav-link_active' : ''
                }`}
                href='#bridge'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'contact' ? ' header__nav-link_active' : ''
                }`}
                href='#contact'
            ...
            <li>
              <a
                className={`header__nav-link${
                  anchor === 'earn' ? ' header__nav-link_active' : ''
                }`}
                href='#earn'

    ...
    <div className="content">
        ...
        <div className="ambrosus-content">
          ...
          <div>
            ...
            <p>
              ...
              system for social and financial interactions on its layer one blockchain, the Ambrosus Network.
            </p>
      ...
      <section id="earn" className="validator">
        ...
        <div className="validator-right">
          ...
          <p>
            Are you thinking of becoming a validator? Here's a step-by-step process
            on how to easily stake your AMB coins using our Arcadia Staking platform.
          </p>
          <UiButton withBorder className="validator-right__btn">Setup node</UiButton>
          <UiButton>Documentation  →</UiButton>
        </div>
      </section>
    </div>
